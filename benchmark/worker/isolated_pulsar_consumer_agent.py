            ...
            try:
                ...
                if now - last_stats_report >= 1.0:
                    try:
                        ...
                        if message_count[0] < 5000 or hist_count > 0:
                            logger.info(f"Pulsar Consumer Agent {agent_id} reporting: msgs={local_stats.messages_received}, e2e_count={hist_count}, epoch={current_epoch}")
